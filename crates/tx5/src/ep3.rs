...
impl Ep3 {
    ...
    pub async fn send(
        ...
        let _peer = sig.assert_peer(peer_id, PeerDir::ActiveOrOutgoing).await?;
...
impl Peer {
    pub async fn new(
        ...
        if ready_state > 2 {
            return Err(Error::str("Data channel closed while connecting peer").into());
        }
